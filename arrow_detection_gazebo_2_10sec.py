...
theta,theta1,sub , a , x_init , y_init,x_goal,y_goal,theta2 = 0,0,0,0,0,0,0,0,0
# a = 0 jab arrow detect ho and align na hogya ho
# a = 1 jab align hogya ho
def callback(data):
    global  theta , a , theta1 , sub , x_init, y_init, x_goal,y_goal,theta2
    ...
    z = Twist()
    if(a == 0):
        angular_velocity= theta2/5 #this is for orienting rover such that arrow is at center line of video feed
        linear_velocity = .1
